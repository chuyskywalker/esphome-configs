...
#include "esphome/components/ruixu_modbus/ruixu_modbus.h"

namespace esphome {
namespace ruixu_bms {

class RuixuBms : public PollingComponent, public ruixu_modbus::RuixuModbusDevice {
 public:
  ...
  void on_ruixu_modbus_data(const std::vector<uint8_t> &data) override;
